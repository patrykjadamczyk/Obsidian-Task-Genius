...
const translations = {
	"Comprehensive task management plugin for Obsidian with progress bars, task status cycling, and advanced task tracking features.":
		"Комплексний плагін для управління завданнями в Obsidian із прогрес-барами, циклічною зміною статусу завдань та розширеними функціями відстеження завдань.",
	...
	"Toggle this to allow this plugin to show progress info when hovering over the progress bar.":
		"Увімкніть, щоб плагін показував інформацію про прогрес при наведенні на прогрес-бар.",
	...
	"Toggle this to allow this plugin to add progress bar for Task below the headings.":
		"Увімкніть, щоб плагін додавав прогрес-бар для завдань під заголовками.",
	...
	"Toggle this to allow this plugin to auto complete parent task when all child tasks are completed.":
		"Увімкніть, щоб плагін автоматично завершував батьківське завдання, коли всі дочірні завдання завершені.",
	...
	"Toggle this to allow this plugin to count sub tasks.":
		"Увімкніть, щоб плагін враховував дочірні завдання.",
	"Task Status Settings": "Налаштування статусу завдань",
	"Select a predefined task status collection or customize your own":
		"Виберіть попередньо визначений набір статусів завдань або налаштуйте власний",
	...
	"Toggle this to enable hiding progress bars based on tags, folders, or metadata.":
		"Увімкніть, щоб приховувати прогрес-бари на основі тегів, папок або метаданих.",
	"Hide by tags": "Приховувати за тегами",
	'Specify tags that will hide progress bars (comma-separated, without #). Example: "no-progress-bar,hide-progress"':
		'Вкажіть теги, які приховуватимуть прогрес-бари (через кому, без #). Приклад: "no-progress-bar,hide-progress"',
	...
	"Choose what type of marker to add to moved tasks":
		"Виберіть тип маркера, який буде додано до переміщених завдань",
	...
	"Say Thank You": "Сказати дякую",
	Donate: "Пожертвувати",
	"If you like this plugin, consider donating to support continued development:":
		"Якщо вам подобається цей плагін, подумайте про пожертву для підтримки подальшого розвитку:",
	...
	"Toggle this to allow this plugin to add tasks number to progress bar.":
		"Увімкніть, щоб плагін додавав число завдань до прогрес-бару.",
	"Show percentage": "Показати відсоток",
	"Toggle this to allow this plugin to show percentage in the progress bar.":
		"Увімкніть, щоб плагін показував відсоток у прогрес-барі.",
	...
	"Preset Filters": "Попередньо встановлені фільтри",
	...
	"Include Completed Tasks": "Включити завершені завдання",
	"Include In Progress Tasks": "Включити завдання в процесі",
	"Include Abandoned Tasks": "Включити покинуті завдання",
	"Include Not Started Tasks": "Включити не розпочаті завдання",
	"Include Planned Tasks": "Включити заплановані завдання",
	...
	"Include Child Tasks": "Включити дочірні завдання",
	"Include Sibling Tasks": "Включити сусідні завдання",
	...
	Save: "Зберегти",
	Cancel: "Скасувати",
	"Hide filter panel": "Приховати панель фільтра",
	"Show filter panel": "Показати панель фільтра",
	"Filter Tasks": "Фільтрувати завдання",
	"Preset filters": "Попередньо встановлені фільтри",
	"Select a saved filter preset to apply":
		"Виберіть збережений попередньо встановлений фільтр для застосування",
	"Select a preset...": "Виберіть попередньо встановлений...",
	Query: "Запит",
	...
	Apply: "Застосувати",
	"New Preset": "Нова попередньо встановлена",
	"Preset saved": "Попередньо встановлена збережена",
	...
	"Quick capture (Global)": "Швидкий захват (глобальний)",
	"Toggle task filter panel": "Перемкнути панель фільтра завдань",
	...
	"Good progress {{PROGRESS}}%": "Хороший прогрес {{PROGRESS}}%",
	...
	"Configure task workflows for project and process management":
		"Налаштуйте робочі процеси завдань для управління проєктами та процесами",
	...
	"A unique identifier for the workflow (used in tags)":
		"Унікальний ідентифікатор для робочого процесу (використовується в тегах)",
	Description: "Опис",
	...
	"A unique identifier for the stage (used in tags)":
		"Унікальний ідентифікатор для етапу (використовується в тегах)",
	...
	Preset: "Попередньо встановлена",
	"Preset name": "Назва попередньо встановленої",
	"Edit Filter": "Редагувати фільтр",
	"Add New Preset": "Додати нову попередньо встановлену",
	...
	"Toggle this to allow this plugin to count sub tasks when generating progress bar\t.":
		"Увімкніть, щоб плагін враховував дочірні завдання при створенні прогрес-бару.",
	...
	"In progress tasks": "Завдання в процесі",
	...
	"Range-based text": "Текст на основі діапазону",
	...
	"Toggle list/tree view": "Перемкнути вигляд списку/дерева",
	...
	tasks: "завдання",
	"No tasks in the selected projects": "Немає завдань у вибраних проєктах",
	"Select a project to see related tasks":
		"Виберіть проєкт, щоб побачити пов’язані завдання",
	...
	"Review every": "Огляд кожні",
	never: "ніколи",
	"Last reviewed": "Останній огляд",
	"Mark as Reviewed": "Позначити як переглянуте",
	...
	"Select a project from the left sidebar to review its tasks.":
		"Виберіть проєкт у лівій бічній панелі, щоб переглянути його завдання.",
	Inbox: "Вхідні",
	Flagged: "Позначені",
	Review: "Огляд",
	"tags selected": "вибрано тегів",
	"No tasks with the selected tags": "Немає завдань із вибраними тегами",
	"Select a tag to see related tasks":
		"Виберіть тег, щоб побачити пов’язані завдання",
	"Open Task Genius view": "Відкрити вигляд Task Genius",
	...
	"Enable task genius view": "Увімкнути вигляд Task Genius",
	"Select a task to view details":
		"Виберіть завдання, щоб переглянути деталі",
	Status: "Статус",
	...
	"New Custom View": "Новий користувацький вигляд",
	"Create Custom View": "Створити користувацький вигляд",
	"Edit View: ": "Редагувати вигляд: ",
	"View Name": "Назва вигляду",
	"My Custom Task View": "Мій користувацький вигляд завдань",
	...
	"Tags Include": "Теги включають",
	"Task must include ALL these tags (comma-separated).":
		"Завдання має включати ВСІ ці теги (розділені комами).",
	"Tags Exclude": "Теги виключають",
	"Task must NOT include ANY of these tags (comma-separated).":
		"Завдання НЕ має включати ЖОДЕН із цих тегів (розділені комами).",
	"Project Is": "Проєкт",
	...
	"Unnamed View": "Безіменний вигляд",
	"View configuration saved.": "Конфігурація вигляду збережена.",
	"Hide Details": "Приховати деталі",
	"Show Details": "Показати деталі",
	"View Config": "Конфігурація вигляду",
	...
	"Move Up": "Перемістити вгору",
	"Move Down": "Перемістити вниз",
	"Delete View": "Видалити вигляд",
	"Add Custom View": "Додати користувацький вигляд",
	...
	"Toggle this to allow this plugin to find the pattern g::number as goal of the parent task.":
		"Увімкніть, щоб плагін шукав шаблон g::number як мету батьківського завдання.",
