...
const translations = {
	...
	"Configure Review for": "為以下項目配置審查",
	"Review Frequency": "審查頻率",
	"How often should this project be reviewed": "這個項目應該多久審查一次",
	"Custom...": "自定義...",
	"e.g., every 3 months": "例如：每3個月",
	"Last Reviewed": "上次審查",
	"Please specify a review frequency": "請指定審查頻率",
	"Review schedule updated for": "已更新審查計劃",
	"Review Projects": "審查項目",
	"Select a project to review its tasks.": "選擇一個項目以審查其任務。",
	"Configured for Review": "已配置審查",
	"Not Configured": "未配置",
	"No projects available.": "沒有可用的項目。",
	"Select a project to review.": "選擇一個項目進行審查。",
	"Show all tasks": "顯示所有任務",
	"Showing all tasks, including completed tasks from previous reviews.":
		"顯示所有任務，包括之前審查中已完成的任務。",
	"Show only new and in-progress tasks": "僅顯示新任務和進行中的任務",
	"No tasks found for this project.": "未找到此項目的任務。",
	"Review every": "每隔多久審查",
	never: "從不",
	"Last reviewed": "上次審查",
	"Mark as Reviewed": "標記為已審查",
	"No review schedule configured for this project": "此項目未配置審查計劃",
	"Configure Review Schedule": "配置審查計劃",
	"Project Review": "項目審查",
	...
	"Open Task Genius view": "打開任務天才視圖",
