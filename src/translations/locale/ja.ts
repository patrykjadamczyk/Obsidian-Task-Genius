...
const translations = {
	...
	"Move to": "移動する",
	Settings: "設定",
	"Just started": "始まったばかり",
	"Making progress": "進行中",
	"Half way": "半分完了",
	"Good progress": "順調に進行中",
	"Almost there": "もう少し",
	"archived on": "アーカイブ日",
	moved: "移動済み",
	"Capture your thoughts...": "考えを記録...",
	...
	"Play a game": "ゲームをする",
	"Eat a piece of chocolate": "チョコレートを一つ食べる",
	common: "一般",
	rare: "レア",
	legendary: "伝説級",
	...
	"Habit type": "習慣タイプ",
	"Daily habit": "毎日の習慣",
	"Simple daily check-in habit": "シンプルな毎日のチェックイン習慣",
	"Count habit": "カウント習慣",
	...
	"(Optional) Specific text representing completion, leave blank for any non-empty value to be considered completed":
		"（任意）完了を表す特定のテキスト、空白のままにすると非空の値はすべて完了とみなされます",
