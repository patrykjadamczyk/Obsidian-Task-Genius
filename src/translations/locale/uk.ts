...
const translations = {
	...
	"Select a preset...": "Оберіть попередньо встановлений...",
	Query: "Запит",
	...
	"View Type": "Тип вигляду",
	"Select the type of view to create": "Виберіть тип вигляду для створення",
	"Standard View": "Стандартний вигляд",
	"Two Column View": "Двоколонковий вигляд",
	Items: "Елементи",
	...
	"Are you sure you want to force reindex all tasks?":
		"Ви впевнені, що хочете примусово переіндексувати всі завдання?",
