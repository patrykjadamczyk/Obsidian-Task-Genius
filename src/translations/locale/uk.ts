...
const translations = {
	...
	"Toggle this to allow this plugin to show progress info when hovering over the progress bar.": "Увімкніть, щоб додаток показував інформацію про прогрес при наведенні на прогрес-бар.",
	...
	"Toggle this to enable hiding progress bars based on tags, folders, or metadata.": "Увімкніть, щоб приховувати прогрес-бар на основі міток, тек, або властивостей.",
	...
	"Specify folder paths that will hide progress bars (comma-separated). Example: \"Daily Notes,Projects/Hidden\"": "Вкажіть шляхи до папок, у яких приховуватиметься прогрес-бар (через кому). Наприклад: \"Daily Notes,Projects/Hidden\"",
	"Hide by metadata": "Приховувати за властивостями",
	"Specify frontmatter metadata that will hide progress bars. Example: \"hide-progress-bar: true\"": "Вкажіть властивість нотатки, яка приховуватиме прогрес-бар. Наприклад: \"hide-progress-bar: true\"",
	...
	"Use {{DATE:format}} for date formatting (e.g., {{DATE:YYYY-MM-DD}}": "Використовуйте {{DATE:format}} для форматування дати (наприклад: {{DATE:YYYY-MM-DD}})",
	...
	"Emoji mark to identify dates. You can use multiple emoji separated by commas.": "Емодзі-маркер для позначення дат. Можна використовувати кілька емодзі, розділених комами.",
	...
	"Toggle this to enable the task filter panel": "Увімкніть, щоб активувати панель фільтра завдань",
	"Preset Filters": "Попередньо встановлені фільтри",
	"Create and manage preset filters for quick access to commonly used task filters.": "Створюйте та керуйте попередньо встановленими фільтрами для швидкого доступу до часто використовуваних фільтрів завдань.",
	...
	"Include parent, child, and sibling tasks in the filter": "Включити батьківські, дочірні та сусідні завдання у фільтр",
	...
	"Use boolean operations: AND, OR, NOT. Example: 'text content AND #tag1'": "Використовуйте булеві операції: AND, OR, NOT. Приклад: 'text content AND #tag1'",
	...
	"Preset filters": "Попередньо встановлені фільтри",
	"Select a saved filter preset to apply": "Оберіть збережений попередньо встановлений фільтр для застосування",
	"Select a preset...": "Оберіть попередньо встановлений...",
	"Query": "Запит",
	"Use boolean operations: AND, OR, NOT. Example: 'text content AND #tag1 AND DATE:<2022-01-02 NOT PRIORITY:>=#B' - Supports >, <, =, >=, <=, != for PRIORITY and DATE.": "Використовуйте булеві операції: AND, OR, NOT. Приклад: 'text content AND #tag1 AND DATE:<2022-01-02 NOT PRIORITY:>=#B' - Підтримує >, <, =, >=, <=, != для PRIORITY і DATE.",
	...
	"No preset filters created yet. Click 'Add New Preset' to create one.": "Попередньо встановлені фільтри ще не створені. Натисніть 'Додати нову попередньо встановлену', щоб створити одну.",
	...
	"A unique identifier for the workflow (used in tags)": "Унікальний ідентифікатор для робочого процесу (використовується у мітках)",
	"Description": "Опис",
	...
	"Reset to Default Presets": "Скинути до попередньо встановлених за замовчуванням",
	"This will replace all your current presets with the default set. Are you sure?": "Це замінить усі ваші поточні попередньо встановлені на набір за замовчуванням. Ви впевнені?",
	"Edit Workflow": "Редагувати робочий процес",
	"General": "Загальні",
	"Progress Bar": "Прогрес-бар",
	...
	"View the documentation for this plugin": "Переглянути документацію для цього плагіна",
	...
	"Use placeholders like {{COMPLETED}}, {{TOTAL}}, {{PERCENT}}, etc.": "Використовуйте заповнювачі, такі як {{COMPLETED}}, {{TOTAL}}, {{PERCENT}} тощо.",
	...
	"No review schedule configured for this project": "Для цього проєкту не налаштовано графік огляду",
	...
	"Details": "Деталі",
	"View": "Вигляд",
	"Task Genius view is a comprehensive view that allows you to manage your tasks in a more efficient way.": "Вигляд Task Genius — це комплексний вигляд, який дозволяє більш ефективно керувати завданнями.",
	...
	"Configure sidebar views, order, visibility, and hide/show completed tasks per view.": "Налаштуйте вигляди бічної панелі, їхній порядок, видимість і приховування/показ завершених завдань для кожного вигляду.",
	...
	"Error: View ID already exists.": "Помилка: Ідентифікатор вигляду вже існує.",
	"Events": "Події",
	"Plan": "План",
	"Year": "Рік",
	"Month": "Місяць",
	...
	"Show a checkbox for each task in the kanban view.": "Показувати прапорець для кожного завдання у вигляді канбан.",
	...
	"Rotate": "Повернути",
	"Are you sure you want to force reindex all tasks?": "Ви впевнені, що хочете примусово переіндексувати всі завдання?",
	"Enable progress bar in reading mode": "Увімкнути прогрес-бар у режимі читання",
	"Toggle this to allow this plugin to show progress bars in reading mode.": "Увімкніть, щоб додаток показував прогрес-бари у режимі читання.",
	"Range": "Діапазон",
